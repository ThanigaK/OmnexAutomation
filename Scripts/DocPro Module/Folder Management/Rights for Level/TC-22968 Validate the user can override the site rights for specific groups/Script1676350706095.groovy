...
WebUI.verifyMatch(Heading, 'Manage Group Rights - LevelWithDocument', false)

WebUI.setText(findTestObject('DocPro_Module/Folder Management/Level Rights/search'), 'DocproAdmin')
