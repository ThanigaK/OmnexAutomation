...
WebUI.verifyElementPresent(findTestObject('DocPro_Module/DocProSetup_Page/Level Owner Remove'), 5)

WebUI.click(findTestObject('DocPro_Module/DocProSetup_Page/Level Owner Remove'))
