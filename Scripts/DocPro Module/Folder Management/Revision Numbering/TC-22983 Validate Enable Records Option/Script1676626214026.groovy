...
WebUI.scrollToElement(findTestObject('DocPro_Module/DocProSetup_Page/records_Checkbox'), 10)

WebUI.click(findTestObject('DocPro_Module/DocProSetup_Page/records_Checkbox'))
