...
'Enter New Sub level name\r\n'
WebUI.setText(findTestObject('DocPro_Module/Folder Management/New Level Name'), NewSub3)
...
'Enter New Sub level name\r\n'
WebUI.setText(findTestObject('DocPro_Module/Folder Management/New Level Name'), NewSub4)
...
for (int i = 1; i <= Column.size(); i++) {
    ...
    if (AttachRight.contains('Inherit')) {
        ...
        DriverFactory.getWebDriver().findElement(By.xpath('//input[@type=\'search\']')).sendKeys('Corporate')

        WebUI.delay(3)

        DriverFactory.getWebDriver().findElement(By.xpath('(//input[@type=\'checkbox\' and contains(@id,\'Fullaccess\')])[1]')).click()
...
WebUI.setText(findTestObject('Object Repository/DocPro_Module/New Documnet Request/levelSearch_TextBox'), levName + Keys.ENTER)

'Validate Corporate should not show the sub level '
WebUI.verifyElementNotPresent(findTestObject('DocPro_Module/Documents_Page/lbl_NoDatFound'), 3)
