...
CustomKeywords.'suiteModule.DocPro.AssignAutoApprovalRoute'('No', 'No', 'Assign by admin')
...
String DocumentNum = CustomKeywords.'suiteModule.DocPro.EnterDocumentNumber'(DocNumber)
...
CustomKeywords.'suiteModule.Documents.assignRouteForCreatedRequest'('Module Auto approval')
