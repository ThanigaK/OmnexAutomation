...
CustomKeywords.'suiteModule.DocPro.goToLevelInDocproSetup'(Page, Level)
...
CustomKeywords.'suiteModule.NewDocRequest.levelSelection'(LevelName)
...
CustomKeywords.'suiteModule.DocPro.validateDocNum'(DocNumOption)

'Navigate to TOC'
CustomKeywords.'suiteModule.HomePage.goToDocumentsPage'()

'Open the Level'
CustomKeywords.'suiteModule.Documents.openLevel'(Level)

'Validate the documet added is present in the list and get it\'s position to delete'
CustomKeywords.'suiteModule.DocPro.DeleteAddedDocument'()

'Right Click on the Newely created Document Number'
CustomKeywords.'suiteModule.DocPro.rightClickOnDoc'()

'Select "Change Request" option'
CustomKeywords.'suiteModule.DocPro.clickOnRightClickOptions'('Change Request')
