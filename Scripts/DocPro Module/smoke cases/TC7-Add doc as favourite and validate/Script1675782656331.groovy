...
CustomKeywords.'suiteModule.HomePage.goToFavouritesPage'()

CustomKeywords.'suiteModule.Documents.createFavouriteFolder'('random')
...
CustomKeywords.'suiteModule.Documents.addCreatedDocumentAsFavouriteDocument'(levName)
