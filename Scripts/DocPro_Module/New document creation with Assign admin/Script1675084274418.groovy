...
CustomKeywords.'ewqims.DocPro.AssignAutoApprovalRoute'('No', 'No', 'Assign by admin')
...
CustomKeywords.'ewqims.Documents.assignRouteForCreatedRequest'('Module Auto approval')
