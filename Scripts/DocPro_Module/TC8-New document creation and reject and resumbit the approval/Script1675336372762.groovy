...
not_run: CustomKeywords.'docPro.KeyWord.LoginwithCredential'(GlobalVariable.url, GlobalVariable.username1, GlobalVariable.Password1)
...
not_run: CustomKeywords.'docPro.KeyWord.NavigateToLevelsPage'()

not_run: levName = CustomKeywords.'docPro.LevelsPage.createLevel'(LevelName)
...
not_run: CustomKeywords.'docPro.DocPro.goToLevelInDocproSetup'('Folder management', levName)

not_run: CustomKeywords.'docPro.DocPro.MakeLevelInUse'()
...
'Adding Level Owner'
not_run: CustomKeywords.'docPro.DocPro.AddLevelOwner'('Empcode', LevelOwner)

'Selecting tag'
not_run: CustomKeywords.'docPro.DocPro.tagSelection'('')
...
not_run: CustomKeywords.'docPro.DocPro.levelpdfPrefSelection'('Document Type', LevelPDFPreference)

not_run: CustomKeywords.'docPro.DocPro.setAutoPublish'('100', Module)
...
not_run: CustomKeywords.'docPro.HomePage.NavigateToNewDocRequestPage'()
...
not_run: CustomKeywords.'docPro.NewDocRequest.levelSelection'(levName)

'Enter Document Number'
not_run: CustomKeywords.'docPro.DocPro.EnterDocNumber'(DocNumber)

'Entering Document Name'
not_run: CustomKeywords.'docPro.DocPro.EnterDocName'(DocName)

'Enter Revision Number'
not_run: CustomKeywords.'docPro.DocPro.enterRevisionNum'(Revison)

not_run: WebUI.delay(10)

'Upload the New Document'
not_run: CustomKeywords.'docPro.DocPro.uploadFile'(FilePath)
...
not_run: CustomKeywords.'docPro.KeyWord.Logout'()

'Login to application with the Credentials'
not_run: CustomKeywords.'docPro.KeyWord.LoginwithCredential'(GlobalVariable.url, 'donotdelete2', 'TtfzLQ/s9dQ=')

not_run: CustomKeywords.'docPro.Documents.NavigateToActionsPage'()

'Rejecting the Document'
not_run: CustomKeywords.'docPro.DocPro.approveOrrejectRequestInRequestNeedingApproval'('Reject', 'TtfzLQ/s9dQ=')
...
CustomKeywords.'docPro.Documents.resubmitTheRejectedRequestInResubmitRejectedRequest'('D:\\\\Omnex\\\\Repo\\\\OmnexAutomation\\\\Files')
...
not_run: CustomKeywords.'docPro.Documents.assignUserInReassignApproval'('doNotDelete_01', 'TtfzLQ/s9dQ=')

not_run: CustomKeywords.'docPro.KeyWord.Logout'()

'Login to application with the Credentials'
not_run: CustomKeywords.'docPro.KeyWord.LoginwithCredential'(GlobalVariable.url, 'doNotDelete_01', 'TtfzLQ/s9dQ=')

not_run: CustomKeywords.'docPro.Documents.NavigateToActionsPage'()

'Approving the Document'
not_run: CustomKeywords.'docPro.DocPro.approveOrrejectRequestInRequestNeedingApproval'('Approve', 'TtfzLQ/s9dQ=')
...
not_run: CustomKeywords.'docPro.LevelsPage.levelDeletion'(levName)

not_run: CustomKeywords.'docPro.HomePage.goToDocumentRoutePage'()

not_run: CustomKeywords.'docPro.RouteCreation.deleteRoute'()
