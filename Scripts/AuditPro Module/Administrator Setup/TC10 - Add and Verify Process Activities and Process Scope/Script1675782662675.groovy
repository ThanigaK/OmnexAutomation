...
CustomKeywords.'auditProModule.ProcessActivities.createNewProcessScopeandVerify'('SCBAuto')

'Delete the Process Scope created above'
CustomKeywords.'auditProModule.ProcessActivities.deleteProcessScope'('')
