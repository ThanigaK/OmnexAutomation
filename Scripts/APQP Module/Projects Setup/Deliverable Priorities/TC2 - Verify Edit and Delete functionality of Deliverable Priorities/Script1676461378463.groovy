...
WebUI.verifyElementPresent(findTestObject('ProjectSetup_Page/PrioritySearchDropdown_GridDP'), 5)

'Verify the Priority Search Input box is present in the Deliverable Priorities page'
WebUI.verifyElementPresent(findTestObject('ProjectSetup_Page/PrioritySearchInput_GridDP'), 5)

'Click on the Add Button '
WebUI.click(findTestObject('ProjectSetup_Page/btn_AddCC'), FailureHandling.STOP_ON_FAILURE)

'Verify the Add Title is Shown in the Add Priority pop up box'
WebUI.verifyElementPresent(findTestObject('ProjectSetup_Page/Lbl_AddTitleDP'), 5)

'Verify the Priority Description is Shown in the Add Priority pop up box'
WebUI.verifyElementPresent(findTestObject('ProjectSetup_Page/PriorityDescription_InputBoxDP'), 5)
...
'Delete the created Deliverable Priorities'
...
'Delete the All Deliverable Priorities'
CustomKeywords.'apqpModule.ProjectSetup.DeleteAllDeliverablePriorities'()
