...
'Click on the Business Rule Option'
...
'Click on the  Business Rule Option'
WebUI.click(findTestObject('ProjectSetup_Page/lbl_Business Rule'))

'Verify business rule button and custom field objects.'
CustomKeywords.'apqpModule.ProjectSetup.BusinessRuleButtonAndCustomFieldObjectsVerify'()

'Verify business rule toggle buttons.'
CustomKeywords.'apqpModule.ProjectSetup.BusinessRuleToggleButtonVerify'()

'Click the save button '
WebUI.click(findTestObject('ProjectSetup_Page/Btn_SaveBR'))

'Verify Save successfull alert message.'
WebUI.verifyElementPresent(findTestObject('ProjectSetup_Page/Alert_SavedSuccessfullyBR'), 0)
