...
WebUI.click(findTestObject('ProjectSetup_Page/Button_NewCT'), FailureHandling.STOP_ON_FAILURE)
...
'Set Module Level Approval settings '
CustomKeywords.'apqpModule.ProjectSetup.setModuleLevelApprovers'('random')
...
'Verify Module Level Approval works as expected'
CustomKeywords.'apqpModule.ProjectSetup.verifyModuleLevelApprovers'('random')
