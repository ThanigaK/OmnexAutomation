...
WebUI.verifyElementPresent(findTestObject('ProjectSetup_Page/Button_DeleteCC'), 5)
...
'Create a Charter Template successfully by using Copy Form functionality'
CustomKeywords.'apqpModule.ProjectSetup.CopyFormCharterTemplate'()
