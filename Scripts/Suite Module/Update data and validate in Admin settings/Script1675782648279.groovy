...
CustomKeywords.'suiteModule.KeyWord.NavigateToAdminSettingPage'()

'Modify and update the Admin settings'
CustomKeywords.'suiteModule.KeyWord.updateAdminSettingPage'(PasswordLenth, LastName, MiddleName, FirstName, Empty1)
...
CustomKeywords.'suiteModule.KeyWord.updateAdminSettingPage'(PasswordLenth, FirstName, MiddleName, LastName, Empty1)
